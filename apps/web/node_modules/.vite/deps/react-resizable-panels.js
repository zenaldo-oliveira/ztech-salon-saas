...
function Vt(e) {
  ...
  }), J.get(p) === 1 && (p.addEventListener("dblclick", Te, true), p.addEventListener("pointerdown", Ae, true), p.addEventListener("pointerleave", je), p.addEventListener("pointermove", He), p.addEventListener("pointerout", Ve), p.addEventListener("pointerup", Ue, true)), function() {
    t = false, J.set(
      p,
      ...
      Ae,
      true
    ), p.removeEventListener("pointerleave", je), p.removeEventListener("pointermove", He), p.removeEventListener("pointerout", Ve), p.removeEventListener("pointerup", Ue, true)), s.disconnect();
  };
}
function Ut() {
